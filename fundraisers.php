...
<body bgcolor="darkchocolate">
  ...
  <section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
      ...
      <input type="number" id="total_amount_raised" name="total_amount_raised" required><br><br>
...
$sql = "INSERT INTO fundraisers (user_id, campaign_id, total_amount_raised) VALUES ('$user_id', '$campaign_id', '$total_amount_raised')";
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Detail information Of fundraisers</title>
    <style>
        table {
            width: 100%;
    ...
    <center><h2>Table of fundraisers</h2></center>
    <table border="3">
      <tr>
        <th>ID</th>
        <th>user_id</th>
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          $eid = $row['fundraiser_id']; // Fetch the Volunteer ID
          echo "<tr>
      <td>" . $row['fundraiser_id'] . "</td>
      <td>" . $row['user_id'] . "</td>
      <td>" . $row['campaign_id'] . "</td>
      <td>" . $row['total_amount_raised'] . "</td>
      <td><a style='padding:4px' href='delete_fundraisers.php?fundraiser_id=$eid'>Delete</a></td> 
      <td><a style='padding:4px' href='update_fundraisers.php?fundraiser_id=$eid'>Update</a></td> 
      </tr>";
